...
Partial Public NotInheritable Class SapAccAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapAccAddIn As SapAccAddIn
    ...
    Friend Shared Property SapAccAddIn() As SapAccAddIn
        Get
            Return _SapAccAddIn
        End Get
        Set
            If (_SapAccAddIn Is Nothing) Then
                _SapAccAddIn = value
            Else
