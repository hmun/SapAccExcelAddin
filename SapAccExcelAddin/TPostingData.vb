Public Class TPostingData
    ...
    Public Sub addTPostingDataRec(pKey As String, pTPostingDataRec As TPostingDataRec)
        ...
        Else
            aTPostingDataRec = New TPostingDataRec(aPar)
            aTPostingDataRec.addValues(pTPostingDataRec)
            aTPostingDataDic.Add(pKey, aTPostingDataRec)
        End If
    End Sub

    Public Function newTPostingDataRec(ByRef pDic As Dictionary(Of String, SAPCommon.TField), Optional pEmpty As Boolean = False, Optional pEmptyChar As String = "#") As TPostingDataRec
        newTPostingDataRec = New TPostingDataRec(pDic:=pDic, pPar:=aPar, pEmpty:=pEmpty, pEmptyChar:=pEmptyChar)
    End Function
